var Hangman = (function () {
  ...
  Hangman.prototype.reset = function () {
    ...
    this.showElementByIdWithContent(
      this.elId + "_word",
      this.getGuessedfWord()
    );
  };
  ...
  Hangman.prototype.guess = function (letter) {
    ...
    if (this.WORD.indexOf(letter) < 0) {
      ...
      if (this.MISTAKES === 6) {
        this.showElementByIdWithContent(
          this.elId + "_end",
          "GAME OVER!<br/>The word was: " + this.WORD
        );
        this.STOPPED = true;
      }
      ...
      this.showElementByIdWithContent(
        this.elId + "_end",
        "You made it!<br/>The word was: " + this.WORD
      );
      this.STOPPED = true;
    }
  };
  ...
  Hangman.prototype.getGuessedfWord = function () {
    ...
    for (i = 0; i < this.WORD.length; i++) {
      // Word characters
      result += this.GUESSES.indexOf(this.WORD[i]) > -1 ? this.WORD[i] : "_";
    }
    return result;
  };
